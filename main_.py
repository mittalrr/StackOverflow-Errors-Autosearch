...
def get_urls(json_dict):
    ...
    for i in json_dict['items']:
        ...
        count+=1
        if count == len(i) or count == 3: # increment count value so as to get more number of links
            break
    import webbrowser
    for i in url_list:
        webbrowser.open(i)
...
if __name__ == "__main__":
    ...
    # if don't want to run test.py file than copy paste the error into error_message below & comment out above two statements
